const { Client, GatewayIntentBits, Partials, Collection, Events, EmbedBuilder, ActionRowBuilder, ButtonBuilder, ButtonStyle, StringSelectMenuBuilder, ModalBuilder, TextInputBuilder, TextInputStyle, PermissionsBitField } = require('discord.js');
const fs = require('fs');
...
client.on(Events.InteractionCreate, async interaction => {
    ...
    const modal = new ModalBuilder()
        ...
        .setTitle(interaction.customId.startsWith('sell') ? 'Sell da hood Order Form' : 'Buy da hood Order Form');
...
client.on(Events.InteractionCreate, async interaction => {
    ...
    const embed = new EmbedBuilder()
        ...
        .addFields(
            { name: 'Item(s)', value: item, inline: false },
